...
@input_guardrail(name="check_hacking")
...
# method to get name of the function by default it's value in class is None but later it is default to the function name
print("check name",hacking_guardrail.get_name())
